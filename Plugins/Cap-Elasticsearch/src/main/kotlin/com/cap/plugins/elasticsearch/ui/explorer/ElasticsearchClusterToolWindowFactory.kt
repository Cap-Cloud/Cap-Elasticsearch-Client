...
@Keep
class ElasticsearchClusterToolWindowFactory : ToolWindowFactory, DumbAware {
    override fun createToolWindowContent(project: Project, toolWindow: ToolWindow) {
        ...
        // 创建一个Explorer
        // 直接创建
        // val clusterExplorer = ElasticsearchClusterToolWindowExplorer(project)
        // 通过Service获取
        val explorer = ServiceManager.getService(project, ElasticsearchClusterToolWindowExplorer::class.java)
