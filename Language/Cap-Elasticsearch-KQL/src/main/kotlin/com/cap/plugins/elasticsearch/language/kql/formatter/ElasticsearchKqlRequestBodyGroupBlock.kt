...
class ElasticsearchKqlRequestBodyGroupBlock(myNode: ASTNode, var mySettings: CodeStyleSettings) :
    ...
    override fun createBlock(node: ASTNode): Block {
        ...
        if (type === ElasticsearchKqlTypes.REQUEST_BODY) {
            return ElasticsearchKqlRequestBodyBlock(
                node,
                mySettings
            )
        }
